var COGS_KEY = 'packsplit_demo_products';
...
function getCogsSnapshot() {
  return JSON.stringify({
    products: sessionStorage.getItem(COGS_KEY) || '{}',
...
function getProducts() {
  try { return JSON.parse(sessionStorage.getItem(COGS_KEY) || '{}'); } catch(e) { return {}; }
}
function fallbackDemoProducts() {
  return {
    'product:stitch_sponge_3ct': {
      name: 'Stitch Sponge 3ct',
      listPrice: '7.49',
      sourcePack: '3',
      sellPack: '2',
      qty: '10',
    ...
    'product:mint_laundry_sheets_60ct': {
      name: 'Mint Laundry Sheets 60ct',
      listPrice: '14.99',
      sourcePack: '1',
      sellPack: '1',
      qty: '25',
    ...
    'product:travel_toothpaste_4pk': {
      name: 'Travel Toothpaste 4pk',
      listPrice: '9.88',
      sourcePack: '4',
      sellPack: '2',
      qty: '15',
    ...
    'product:bamboo_wipes_6pk': {
      name: 'Bamboo Wipes 6pk',
      listPrice: '18.49',
      sourcePack: '6',
      sellPack: '3',
      qty: '10',
...
async function seedDemoProductsIfNeeded() {
  sessionStorage.setItem(COGS_KEY, JSON.stringify(await loadDemoProducts()));
}
function saveProductsToStorage(data) {
  pushCogsUndo();
  sessionStorage.setItem(COGS_KEY, JSON.stringify(data));
}
