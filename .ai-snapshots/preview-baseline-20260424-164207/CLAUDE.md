...
- Capture the current live Preview codebase exactly as it exists before the requested changes
- Include every file that may be modified by the update batch
